internal class Program
{
    ...
    private static ValleyState[] Init(string inputFilename)
    {
        string[] valleyGround = File.ReadAllLines(inputFilename);
        return generateAllValleyStates(valleyGround);
    } 
    private static void Main(string[] args)
    {
        ValleyState[] valleyStates = Init(@"input.txt");
